    ...
    return (
      ...
      >
        <div style={{ left: '50%', top: '50%', position: 'absolute' }}>
          ...
          <Circle store={store} v={[ 0, 16, 19 ]} n={1} x={-2} y={1} text='I' fn='tonic' q='' />
          <Circle store={store} v={[ 2, 17, 21 ]} n={2} x={0} y={1} text='ii' fn='subdominant' q='m' />
          <Circle store={store} v={[ 4, 19, 23 ]} n={3} x={2} y={1} text='iii' fn='tonic' q='m' />
          <Circle store={store} v={[ 5, 12, 21 ]} n={4} x={-3} y={-1} text='IV' fn='subdominant' />
          <Circle store={store} v={[ 7, 14, 23 ]} n={5} x={-1} y={-1} text='V' fn='dominant' />
          <Circle store={store} v={[ 9, 16, 24 ]} n={6} x={1} y={-1} text='vi' fn='tonic' q='m' />
          <Circle store={store} v={[ -1, 14, 17 ]} n={7} x={3} y={-1} text='vii°' fn='dominant' q='dim' />
        </div>
      </div>
    )
  }
...
const KeyIndicator = observer(function KeyIndicator (props) {
  ...
  return <KeyIndicatorText><strong>Key:</strong> {keyText}</KeyIndicatorText>
})
